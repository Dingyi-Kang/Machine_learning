## In order to make the custom layer able to infer the dimension of the input shape (namely, we don't have to specify the input shape each time when initializing a custom layer)
